...
const pages = [
  ["Brown Dwarf Photometry", "/js/bd-colors"],
  ["Brown Dwarf Evolution", "/js/bd-evolution"],
  ["Companion Explorer", "/js/companion-explorer"],
  ["Exoplanets Explorer", "/js/exoplanets-explorer"],
  ["Gaia CMD", "/js/gaia-cmd"],
  ["MOCA Explorer", "/js/moca-explorer"],
  ["BANYAN Sigma", "/js/banyan-sigma"],
  ["Group Hierarchy", "/js/group-hierarchy"],
  ["Spectral Typing", "/js/spectral-typing"],
  ["Spectral Explorer", "/js/spectra"],
  ["Spectral Index Explorer", "/js/spectral-index-explorer"],
  ["SED Explorer", "/js/sed"],
  ["Atmospheric Retrieval", "/js/retrieval-explorer"],
  ["Astrometric Explorer", "/js/astrometry"],
  ["Spatial-Kinematic", "/js/xyz"],
  ["Dual XYZ/UVW", "/js/xyz-dual"],
  ["Age PDF Explorer", "/js/age-pdfs"],
